...
*/
  ...
  signal->AddFriend("ntSkim");
   ...
   //                           "!H:!V:FitMethod=MC:EffSel:SampleSize=200000:VarProp=FSmart" );
                           "!H:!V:FitMethod=MC:EffSel:VarProp[0]=FMax:VarProp[1]=FMax:VarProp[2]=FMax:VarProp[3]=FMax:VarProp[4]=FMax:VarProp[5]=FMax:VarProp[6]=FMin:VarProp[7]=FMin:VarProp[8]=FMax:VarProp[9]=FMax" );
