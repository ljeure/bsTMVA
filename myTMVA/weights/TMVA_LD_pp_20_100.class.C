...
{
   fLDCoefficients.push_back( -0.000128467833071 );
   fLDCoefficients.push_back( 0.000724379691718 );
   fLDCoefficients.push_back( 0.00306669343817 );
   fLDCoefficients.push_back( -0.000602339296478 );
   fLDCoefficients.push_back( -0.00275461796343 );
